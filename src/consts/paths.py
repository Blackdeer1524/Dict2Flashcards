...
SYSTEM = system()
if SYSTEM == "Linux":
    MEDIA_DOWNLOADED_LOCATION = USER_FOLDER / ".local/share/Anki2/"
elif SYSTEM == "Windows":
    MEDIA_DOWNLOADED_LOCATION = USER_FOLDER / "AppData/Roaming/Anki2/"
else:
    MEDIA_DOWNLOADED_LOCATION = ROOT_DIR

if not MEDIA_DOWNLOADED_LOCATION.exists():
    MEDIA_DOWNLOADED_LOCATION = ROOT_DIR
