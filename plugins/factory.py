...
class PluginFactory:
    ...
    def __init__(self):
        ...
        super().__setattr__("web_word_parsers",
                            PluginLoader("web word", parsers.word_parsers.web, WebWordParserContainer))
        super().__setattr__("local_word_parsers",
                            PluginLoader("local word", parsers.word_parsers.local, LocalWordParserContainer))
        super().__setattr__("web_sent_parsers",
                            PluginLoader("web sentence", parsers.sentence_parsers, WebSentenceParserContainer))
        super().__setattr__("image_parsers",
                            PluginLoader("web image", parsers.image_parsers, ImageParserContainer))
